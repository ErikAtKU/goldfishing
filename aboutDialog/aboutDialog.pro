            ...
            {  :-
                ...
                F2 =
                    gui_native::logfont(Height * 3 div 2, Width, Esc, Ori, 800, Italic, Underline, StrikeOut, CharSet, OutPrec, ClipPrec, Qual,
                        Pitch, Face),
                version1_ctl:setFont(F2)
            }).

% This code is maintained automatically, do not update it manually.%  01:00:27-23.10.2015
facts
...
clauses
    generatedInitialize() :-
        ...
        version2_ctl:setAlignment(alignLeft),
